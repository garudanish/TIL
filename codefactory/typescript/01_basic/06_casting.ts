...
let string = number as string; // number를 string으로 캐스팅.

console.log(typeof (number as string)); // number. 하지만 자동완성은 string 자료형에 맞게 나옴.

let number2 = 2;

console.log((number as any).toUpperCase()); // 에러가 나지 않음
